              ...
              <v-form>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="12" md="12">
                      <v-textarea :rules='inputRules' required v-model="editedItem.description" label="Task description"></v-textarea>
                    </v-col>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      ...
                      >
                        <template v-slot:activator="{ on }">
                          <v-text-field
                          :rules='inputRules'
                            v-model="editedItem.ends"
                            label="Start date"
                            readonly
                            v-on="on"
                          ></v-text-field>
                        </template>
                        <v-date-picker v-model="editedItem.ends" @input="menu2 = false"></v-date-picker>
                      </v-menu>
                    </v-col>
                  </v-row>
                </v-container>
